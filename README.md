...
Access control lists was implemented to regulate traffic flow and enforce network security policies.

Extended ACLs were used to providegranular control based on source, destination, protocol, and port.

ACLs were configured on the router to segment network access between VLANs.
...
[small secure network topology.pkt.zip](https://github.com/user-attachments/files/25741494/small.secure.network.topology.pkt.zip)# Secure-Network-Topology
